Governance | CoinAPI.io Documentation
...
Overview of CoinAPI's index governance committees](/indexes-api/governance/index-committees)

[📄️ Methodology Review
---------------------

CoinAPI's index methodology review process](/indexes-api/governance/methodology-review)

[📄️ Internal Oversight
---------------------

CoinAPI's internal oversight processes for index administration](/indexes-api/governance/internal-oversight)

[Previous

Complaints Procedure](/indexes-api/index-policies/complaints-procedure)[Next
