Index Maintenance | CoinAPI.io Documentation
...
[Products](/category/index-maintenance)
...
[📄️ Rebalancing and Reconstitution
---------------------------------

CoinAPI's approach to maintaining index accuracy through regular reassessment and rebalancing](/indexes-api/index-maintenance/rebalancing-and-reconstitution)

[📄️ Corporate Action Treatment
-----------------------------

CoinAPI's approach to handling corporate actions in index maintenance](/indexes-api/index-maintenance/corporate-action-treatment)

[Previous

Exchange Eligibility](/indexes-api/eligibility-criteria/exchange-eligibility)[Next
