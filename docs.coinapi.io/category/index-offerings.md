Index offerings | CoinAPI.io Documentation
...
[Products](/category/index-offerings)
...
[📄️ Principal Market Price
-------------------------

Principal Market Price Index (PRIMKT)](/indexes-api/index-offerings/primkt-index)

[📄️ Volume Weighted Average Price
--------------------------------

Volume-Weighted Average Price Index (VWAP)](/indexes-api/index-offerings/vwap-index)

[📄️ Volatility Index
-------------------

CoinAPI Volatility Index (CAPIVIX)](/indexes-api/index-offerings/capivix-index)

[Previous

Governance and Oversight](/indexes-api/introduction/governance-and-oversight)[Next
