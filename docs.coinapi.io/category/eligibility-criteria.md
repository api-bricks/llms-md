Eligibility Criteria | CoinAPI.io Documentation
...
[Products](/category/eligibility-criteria)
...
CoinAPI's comprehensive approach to selecting assets for inclusion in our indexes](/indexes-api/eligibility-criteria/asset-eligibility)

[📄️ Exchange Eligibility
-----------------------

CoinAPI's rigorous process for selecting exchanges to be included in our index calculations](/indexes-api/eligibility-criteria/exchange-eligibility)

[Previous

CAPIVIX Index Methodology](/indexes-api/index-calculation-methodologies/capivix-index-methodology)[Next
