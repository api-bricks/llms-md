getnetworkinfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getnetworkinfo)
...
Overview[​](/naas-api/bitcoin/Methods/getnetworkinfo#overview "Direct link to Overview")
----------------------------------------------------------------------------------------

The **'getnetworkinfo'** method returns an object containing various state info regarding P2P networking.

Request[​](/naas-api/bitcoin/Methods/getnetworkinfo#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnetworkinfo\",\"params\": [ ]}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getnetworkinfo","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnetworkinfo\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getnetworkinfo#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/bitcoin/Methods/getnetworkinfo#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
getnetworkhashps](/naas-api/bitcoin/Methods/getnetworkhashps)[Next

getNewAddress](/naas-api/bitcoin/Methods/getnewaddress)

* [Overview](/naas-api/bitcoin/Methods/getnetworkinfo#overview)
* [Request](/naas-api/bitcoin/Methods/getnetworkinfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getnetworkinfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getnetworkinfo#response)
