importprunedfunds | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importprunedfunds)
...
Overview[​](/naas-api/bitcoin/Methods/importprunedfunds#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------

The **'importprunedfunds'** Imports funds without rescan.

Request[​](/naas-api/bitcoin/Methods/importprunedfunds#request "Direct link to Request")
----------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importprunedfunds\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"importprunedfunds","params": [ ]}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importprunedfunds#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/importprunedfunds#response "Direct link to Response")
-------------------------------------------------------------------------------------------
...
importprivkey](/naas-api/bitcoin/Methods/importprivkey)[Next

importpubkey](/naas-api/bitcoin/Methods/importpubkey)

* [Overview](/naas-api/bitcoin/Methods/importprunedfunds#overview)
* [Request](/naas-api/bitcoin/Methods/importprunedfunds#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importprunedfunds#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importprunedfunds#response)
