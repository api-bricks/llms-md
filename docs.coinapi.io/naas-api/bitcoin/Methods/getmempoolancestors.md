...
[Products](/naas-api/bitcoin/Methods/getmempoolancestors)
...
Overview[​](/naas-api/bitcoin/Methods/getmempoolancestors#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------

The **'getmempoolancestors'** RPC Method returns all in-mempool ancestors for a transaction in the mempool.

Request[​](/naas-api/bitcoin/Methods/getmempoolancestors#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/getmempoolancestors#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getmempoolancestors#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
getmemoryinfo](/naas-api/bitcoin/Methods/getmemoryinfo)[Next

getmempooldescendants](/naas-api/bitcoin/Methods/getmempooldescendants)

* [Overview](/naas-api/bitcoin/Methods/getmempoolancestors#overview)
* [Request](/naas-api/bitcoin/Methods/getmempoolancestors#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getmempoolancestors#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getmempoolancestors#response)
