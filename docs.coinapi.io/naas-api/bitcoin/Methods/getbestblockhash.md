getbestblockhash | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getbestblockhash)
...
Overview[​](/naas-api/bitcoin/Methods/getbestblockhash#overview "Direct link to Overview")
------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getbestblockhash#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getbestblockhash\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getbestblockhash","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getbestblockhash#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getbestblockhash#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
getbalances](/naas-api/bitcoin/Methods/getbalances)[Next

getblock](/naas-api/bitcoin/Methods/getblock)

* [Overview](/naas-api/bitcoin/Methods/getbestblockhash#overview)
* [Request](/naas-api/bitcoin/Methods/getbestblockhash#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getbestblockhash#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getbestblockhash#response)
