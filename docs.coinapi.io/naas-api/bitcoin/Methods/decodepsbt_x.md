...
[Products](/naas-api/bitcoin/Methods/decodepsbt_x)
...
Overview[​](/naas-api/bitcoin/Methods/decodepsbt_x#overview "Direct link to Overview")
--------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/decodepsbt_x#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/decodepsbt_x#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

* **psbt** (string): The PSBT string that needs to be decoded.

Response[​](/naas-api/bitcoin/Methods/decodepsbt_x#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
Errors[​](/naas-api/bitcoin/Methods/decodepsbt_x#errors "Direct link to Errors")
--------------------------------------------------------------------------------
...
Rate Limits[​](/naas-api/bitcoin/Methods/decodepsbt_x#rate-limits "Direct link to Rate Limits")
-----------------------------------------------------------------------------------------------
...
Support[​](/naas-api/bitcoin/Methods/decodepsbt_x#support "Direct link to Support")
-----------------------------------------------------------------------------------

If you encounter any issues or have further questions regarding the decodePSBT method, please contact our support team at **[[email protected]](/cdn-cgi/l/email-protection#6e1d1b1e1e011c1a2e0d0107000f1e07400701)**.
...
decodeRawTransaction](/naas-api/bitcoin/Methods/decodeRawTransaction)[Next

Decodescript](/naas-api/bitcoin/Methods/decodescript)

* [Overview](/naas-api/bitcoin/Methods/decodepsbt_x#overview)
* [Request](/naas-api/bitcoin/Methods/decodepsbt_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/decodepsbt_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/decodepsbt_x#response)
* [Errors](/naas-api/bitcoin/Methods/decodepsbt_x#errors)
* [Rate Limits](/naas-api/bitcoin/Methods/decodepsbt_x#rate-limits)
* [Support](/naas-api/bitcoin/Methods/decodepsbt_x#support)
