getmemoryinfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getmemoryinfo)
...
Overview[​](/naas-api/bitcoin/Methods/getmemoryinfo#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'getmemoryinfo'** RPC Method returns an object that contains information regarding memory usage.

Request[​](/naas-api/bitcoin/Methods/getmemoryinfo#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getmemoryinfo\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getmemoryinfo","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getmemoryinfo#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getmemoryinfo#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
**locked**: Information about locked memory manager
**used**: Number of bytes used
**free**: Number of bytes available in current arenas
**total**: Total number of bytes managed
**locked**: Amount of bytes that succeeded locking. If this number is smaller than total, locking pages failed at some point and key data could be swapped to disk
**chunks\_used**: Number allocated chunks
**chunks\_free**: Number of unused chunks
...
getindexinfo](/naas-api/bitcoin/Methods/getindexinfo)[Next

getmempoolancestors](/naas-api/bitcoin/Methods/getmempoolancestors)

* [Overview](/naas-api/bitcoin/Methods/getmemoryinfo#overview)
* [Request](/naas-api/bitcoin/Methods/getmemoryinfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getmemoryinfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getmemoryinfo#response)
