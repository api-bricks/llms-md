getindexinfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getindexinfo)
...
Overview[​](/naas-api/bitcoin/Methods/getindexinfo#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **'getindexinfo'** RPC Method returns the status of one or all available indexes actively running in the node.

Request[​](/naas-api/bitcoin/Methods/getindexinfo#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getindexinfo\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getindexinfo","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getindexinfo#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

**index\_name** (string): It filters results for an index with a specific name

Response[​](/naas-api/bitcoin/Methods/getindexinfo#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
**txindex**: The index name.
**synced**: It states whether the index is synced or not
**best\_block\_height**: The height of the block to which the index is synced
...
getdifficulty](/naas-api/bitcoin/Methods/getdifficulty)[Next

getmemoryinfo](/naas-api/bitcoin/Methods/getmemoryinfo)

* [Overview](/naas-api/bitcoin/Methods/getindexinfo#overview)
* [Request](/naas-api/bitcoin/Methods/getindexinfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getindexinfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getindexinfo#response)
