getconnectioncount | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getconnectioncount)
...
Overview[​](/naas-api/bitcoin/Methods/getconnectioncount#overview "Direct link to Overview")
--------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getconnectioncount#request "Direct link to Request")
-----------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getconnectioncount\",\"params\": [],\"id\":1}", null, "application/json");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getconnectioncount#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getconnectioncount#response "Direct link to Response")
--------------------------------------------------------------------------------------------
...
**n**: Represents the total number of connections to other nodes, encompassing both inbound and outbound connections.
**error**: Contains the error message, if any, that occurred while attempting to retrieve the connection count.
...
getchaintxstats](/naas-api/bitcoin/Methods/getchaintxstats)[Next

getdifficulty](/naas-api/bitcoin/Methods/getdifficulty)

* [Overview](/naas-api/bitcoin/Methods/getconnectioncount#overview)
* [Request](/naas-api/bitcoin/Methods/getconnectioncount#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getconnectioncount#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getconnectioncount#response)
