getNewAddress | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getnewaddress)
...
Overview[​](/naas-api/bitcoin/Methods/getnewaddress#overview "Direct link to Overview")
---------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getnewaddress#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getNewAddress\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getNewAddress","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getNewAddress\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getnewaddress#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

* **abel** (optional): A label for the address. It is used to assign a name to the address for your reference.
* **address\_type** (optional): Specifies the type of the address. It can be 'legacy', 'p2sh-segwit', or 'bech32'.

Response[​](/naas-api/bitcoin/Methods/getnewaddress#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
getnetworkinfo](/naas-api/bitcoin/Methods/getnetworkinfo)[Next

getnodeaddresses](/naas-api/bitcoin/Methods/getnodeaddresses)

* [Overview](/naas-api/bitcoin/Methods/getnewaddress#overview)
* [Request](/naas-api/bitcoin/Methods/getnewaddress#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getnewaddress#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getnewaddress#response)
