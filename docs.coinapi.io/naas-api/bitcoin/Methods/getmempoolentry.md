getmempoolentry | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getmempoolentry)
...
Overview[​](/naas-api/bitcoin/Methods/getmempoolentry#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getmempoolentry#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"1.0\",\"id\":1,\"method\":\"getmempoolentry\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"1.0","id":1,"method":"getmempoolentry","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"1.0\",\"id\":1,\"method\":\"getmempoolentry\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getmempoolentry#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------

* **transaction\_id (string)**: The ID of the transaction you want to retrieve information for.

Response[​](/naas-api/bitcoin/Methods/getmempoolentry#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
getmempooldescendants](/naas-api/bitcoin/Methods/getmempooldescendants)[Next

getmempoolinfo](/naas-api/bitcoin/Methods/getmempoolinfo)

* [Overview](/naas-api/bitcoin/Methods/getmempoolentry#overview)
* [Request](/naas-api/bitcoin/Methods/getmempoolentry#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getmempoolentry#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getmempoolentry#response)
