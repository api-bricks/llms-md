getblockhash | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getblockhash)
...
Overview[​](/naas-api/bitcoin/Methods/getblockhash#overview "Direct link to Overview")
--------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getblockhash#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getblockhash\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getblockhash","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getblockhash#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getblockhash#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
getblockfilter](/naas-api/bitcoin/Methods/getblockfilter)[Next

getblockheader](/naas-api/bitcoin/Methods/getblockheader)

* [Overview](/naas-api/bitcoin/Methods/getblockhash#overview)
* [Request](/naas-api/bitcoin/Methods/getblockhash#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getblockhash#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getblockhash#response)
