gettransaction | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/gettransaction)
...
Overview[​](/naas-api/bitcoin/Methods/gettransaction#overview "Direct link to Overview")
----------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/gettransaction#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"gettransaction\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"gettransaction","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"gettransaction\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/gettransaction#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------

* **transaction\_id** (string): The ID of the transaction you want to retrieve information about.
...
Response[​](/naas-api/bitcoin/Methods/gettransaction#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
getrpcinfo](/naas-api/bitcoin/Methods/getrpcinfo)[Next

gettxout](/naas-api/bitcoin/Methods/gettxout)

* [Overview](/naas-api/bitcoin/Methods/gettransaction#overview)
* [Request](/naas-api/bitcoin/Methods/gettransaction#request)
* [Request Parameters](/naas-api/bitcoin/Methods/gettransaction#request-parameters)
* [Response](/naas-api/bitcoin/Methods/gettransaction#response)
