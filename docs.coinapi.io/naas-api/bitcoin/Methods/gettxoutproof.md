gettxoutproof | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/gettxoutproof)
...
Overview[​](/naas-api/bitcoin/Methods/gettxoutproof#overview "Direct link to Overview")
---------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/gettxoutproof#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"gettxoutproof\",\"params\": [ ]}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"gettxoutproof","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"gettxoutproof\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/gettxoutproof#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/gettxoutproof#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
gettxout](/naas-api/bitcoin/Methods/gettxout)[Next

gettxoutsetinfo](/naas-api/bitcoin/Methods/gettxoutsetinfo)

* [Overview](/naas-api/bitcoin/Methods/gettxoutproof#overview)
* [Request](/naas-api/bitcoin/Methods/gettxoutproof#request)
* [Request Parameters](/naas-api/bitcoin/Methods/gettxoutproof#request-parameters)
* [Response](/naas-api/bitcoin/Methods/gettxoutproof#response)
