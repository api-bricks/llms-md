...
[Products](/naas-api/bitcoin/Methods/help)
...
Overview[​](/naas-api/bitcoin/Methods/help#overview "Direct link to Overview")
------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/help#request "Direct link to Request")
---------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"help\",\"params\": [ ]}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"help","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"help\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/help#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------

* **command\_name (string, optional)**: The name of the command to get help on. If omitted, the API will return a list of all available commands. The default value is "all commands".

Response[​](/naas-api/bitcoin/Methods/help#response "Direct link to Response")
------------------------------------------------------------------------------
...
gettxoutsetinfo](/naas-api/bitcoin/Methods/gettxoutsetinfo)[Next

importAddress](/naas-api/bitcoin/Methods/importaddress)

* [Overview](/naas-api/bitcoin/Methods/help#overview)
* [Request](/naas-api/bitcoin/Methods/help#request)
* [Request Parameters](/naas-api/bitcoin/Methods/help#request-parameters)
* [Response](/naas-api/bitcoin/Methods/help#response)
