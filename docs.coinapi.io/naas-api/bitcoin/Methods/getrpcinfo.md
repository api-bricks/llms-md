getrpcinfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getrpcinfo)
...
Overview[​](/naas-api/bitcoin/Methods/getrpcinfo#overview "Direct link to Overview")
------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getrpcinfo#request "Direct link to Request")
---------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getrpcinfo\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getrpcinfo","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getrpcinfo\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getrpcinfo#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------

The **'getrpcinfo'** method does not require any parameters. Simply include an empty array in the params field.\

Response[​](/naas-api/bitcoin/Methods/getrpcinfo#response "Direct link to Response")
------------------------------------------------------------------------------------
...
getreceivedbylabel](/naas-api/bitcoin/Methods/getreceivedbylabel)[Next

gettransaction](/naas-api/bitcoin/Methods/gettransaction)

* [Overview](/naas-api/bitcoin/Methods/getrpcinfo#overview)
* [Request](/naas-api/bitcoin/Methods/getrpcinfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getrpcinfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getrpcinfo#response)
