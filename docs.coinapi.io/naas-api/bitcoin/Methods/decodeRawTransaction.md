...
[Products](/naas-api/bitcoin/Methods/decodeRawTransaction)
...
Overview[​](/naas-api/bitcoin/Methods/decodeRawTransaction#overview "Direct link to Overview")
----------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/decodeRawTransaction#request "Direct link to Request")
-------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/decodeRawTransaction#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/decodeRawTransaction#response "Direct link to Response")
----------------------------------------------------------------------------------------------
...
* **weight**: The weight of the transaction, calculated as a value between vsize*4 - 3 and vsize*4.
...
Errors[​](/naas-api/bitcoin/Methods/decodeRawTransaction#errors "Direct link to Errors")
----------------------------------------------------------------------------------------
...
Rate Limits[​](/naas-api/bitcoin/Methods/decodeRawTransaction#rate-limits "Direct link to Rate Limits")
-------------------------------------------------------------------------------------------------------
...
Support[​](/naas-api/bitcoin/Methods/decodeRawTransaction#support "Direct link to Support")
-------------------------------------------------------------------------------------------

If you encounter any issues or have further questions regarding the decodeRawTransaction method, please contact our support team at **[[email protected]](/cdn-cgi/l/email-protection#2b585e5b5b44595f6b484442454a5b42054244)**.
...
createwallet](/naas-api/bitcoin/Methods/createwallet_x)[Next

decodePSBT](/naas-api/bitcoin/Methods/decodepsbt_x)

* [Overview](/naas-api/bitcoin/Methods/decodeRawTransaction#overview)
* [Request](/naas-api/bitcoin/Methods/decodeRawTransaction#request)
* [Request Parameters](/naas-api/bitcoin/Methods/decodeRawTransaction#request-parameters)
* [Response](/naas-api/bitcoin/Methods/decodeRawTransaction#response)
* [Errors](/naas-api/bitcoin/Methods/decodeRawTransaction#errors)
* [Rate Limits](/naas-api/bitcoin/Methods/decodeRawTransaction#rate-limits)
* [Support](/naas-api/bitcoin/Methods/decodeRawTransaction#support)
