listaddressgroupings | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/listaddressgroupings)
...
Overview[​](/naas-api/bitcoin/Methods/listaddressgroupings#overview "Direct link to Overview")
----------------------------------------------------------------------------------------------

The **'listaddressgroupings RPC Method'** method Fills the keypool.

Request[​](/naas-api/bitcoin/Methods/listaddressgroupings#request "Direct link to Request")
-------------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"listaddressgroupings\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"listaddressgroupings","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"listaddressgroupings\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/listaddressgroupings#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------------

* **str**: TThe bitcoin address

Response[​](/naas-api/bitcoin/Methods/listaddressgroupings#response "Direct link to Response")
----------------------------------------------------------------------------------------------
...
listReceivedByAddress](/naas-api/bitcoin/Methods/listReceivedByAddress)[Next

listbanned](/naas-api/bitcoin/Methods/listbanned)

* [Overview](/naas-api/bitcoin/Methods/listaddressgroupings#overview)
* [Request](/naas-api/bitcoin/Methods/listaddressgroupings#request)
* [Request Parameters](/naas-api/bitcoin/Methods/listaddressgroupings#request-parameters)
* [Response](/naas-api/bitcoin/Methods/listaddressgroupings#response)
