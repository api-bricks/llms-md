getnettotals | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getnettotals)
...
Overview[​](/naas-api/bitcoin/Methods/getnettotals#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **'getnettotals'** method returns information about network traffic, including bytes in, bytes out, and current time.

Request[​](/naas-api/bitcoin/Methods/getnettotals#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
wget --no-check-certificate --quiet \  
  ...
  --body-data '{"jsonrpc":"2.0","id":1,"method":"getnettotals","params": [ ]}' \  
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnettotals\",\"params\": [ ]}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getnettotals","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnettotals\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getnettotals#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/bitcoin/Methods/getnettotals#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
getmininginfo](/naas-api/bitcoin/Methods/getmininginfo)[Next

getnetworkhashps](/naas-api/bitcoin/Methods/getnetworkhashps)

* [Overview](/naas-api/bitcoin/Methods/getnettotals#overview)
* [Request](/naas-api/bitcoin/Methods/getnettotals#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getnettotals#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getnettotals#response)
