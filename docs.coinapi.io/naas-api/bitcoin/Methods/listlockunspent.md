listlockunspent | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/listlockunspent)
...
Overview[​](/naas-api/bitcoin/Methods/listlockunspent#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **'listlockunspent'** Returns the list of all labels, or labels that are assigned to addresses with a specific purpose.

Request[​](/naas-api/bitcoin/Methods/listlockunspent#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"listlockunspent\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"listlockunspent","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/listlockunspent#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------

* **txid**: The transaction id locked

Response[​](/naas-api/bitcoin/Methods/listlockunspent#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
listlabels](/naas-api/bitcoin/Methods/listlabels)[Next

listsinceblock](/naas-api/bitcoin/Methods/listsinceblock)

* [Overview](/naas-api/bitcoin/Methods/listlockunspent#overview)
* [Request](/naas-api/bitcoin/Methods/listlockunspent#request)
* [Request Parameters](/naas-api/bitcoin/Methods/listlockunspent#request-parameters)
* [Response](/naas-api/bitcoin/Methods/listlockunspent#response)
