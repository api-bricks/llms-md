generatetoaddress | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/generatetoaddress)
...
Overview[​](/naas-api/bitcoin/Methods/generatetoaddress#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/generatetoaddress#request "Direct link to Request")
----------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"generatetoaddress\",\"params\": [],\"id\":1}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","method":"generatetoaddress","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/generatetoaddress#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------

* **number\_of\_blocks** (integer): The number of blocks to generate.
* **address** (string): The address to which the newly generated blocks should be sent.

Response[​](/naas-api/bitcoin/Methods/generatetoaddress#response "Direct link to Response")
-------------------------------------------------------------------------------------------
...
generateBlock](/naas-api/bitcoin/Methods/generateblock)[Next

generatetodescriptor](/naas-api/bitcoin/Methods/generatetodescriptor)

* [Overview](/naas-api/bitcoin/Methods/generatetoaddress#overview)
* [Request](/naas-api/bitcoin/Methods/generatetoaddress#request)
* [Request Parameters](/naas-api/bitcoin/Methods/generatetoaddress#request-parameters)
* [Response](/naas-api/bitcoin/Methods/generatetoaddress#response)
