combineRawTransaction | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/combinerawtransaction_x)
...
Overview[​](/naas-api/bitcoin/Methods/combinerawtransaction_x#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/combinerawtransaction_x#request "Direct link to Request")
----------------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"combineRawTransaction\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"combineRawTransaction","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/combinerawtransaction_x#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/combinerawtransaction_x#response "Direct link to Response")
-------------------------------------------------------------------------------------------------
...
combinepsbt](/naas-api/bitcoin/Methods/combinepsbt_x)[Next

createmultisig](/naas-api/bitcoin/Methods/createmultisig_x)

* [Overview](/naas-api/bitcoin/Methods/combinerawtransaction_x#overview)
* [Request](/naas-api/bitcoin/Methods/combinerawtransaction_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/combinerawtransaction_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/combinerawtransaction_x#response)
