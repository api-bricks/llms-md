getmininginfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getmininginfo)
...
Overview[​](/naas-api/bitcoin/Methods/getmininginfo#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'getmininginfo'** method returns a json object containing mining-related information.

Request[​](/naas-api/bitcoin/Methods/getmininginfo#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"1.0\",\"id\":1,\"method\":\"getmininginfo\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"1.0","id":1,"method":"getmininginfo","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"1.0\",\"id\":1,\"method\":\"getmininginfo\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getmininginfo#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/bitcoin/Methods/getmininginfo#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
getmempoolinfo](/naas-api/bitcoin/Methods/getmempoolinfo)[Next

getnettotals](/naas-api/bitcoin/Methods/getnettotals)

* [Overview](/naas-api/bitcoin/Methods/getmininginfo#overview)
* [Request](/naas-api/bitcoin/Methods/getmininginfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getmininginfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getmininginfo#response)
