abortrescan | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/abortrescan_x)
...
Overview[​](/naas-api/bitcoin/Methods/abortrescan_x#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'abortrescan'** Stops current wallet rescan triggered by an RPC call, e.g. by an importprivkey call.

Request[​](/naas-api/bitcoin/Methods/abortrescan_x#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"abortrescan\",\"params\": [],\"id\":1}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","method":"abortrescan","params": [],"id":1}`)  
...
Response[​](/naas-api/bitcoin/Methods/abortrescan_x#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
abandontransaction](/naas-api/bitcoin/Methods/abandontransaction_x)[Next

addnode](/naas-api/bitcoin/Methods/addnode_x)

* [Overview](/naas-api/bitcoin/Methods/abortrescan_x#overview)
* [Request](/naas-api/bitcoin/Methods/abortrescan_x#request)
* [Response](/naas-api/bitcoin/Methods/abortrescan_x#response)
