importprivkey | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importprivkey)
...
Overview[​](/naas-api/bitcoin/Methods/importprivkey#overview "Direct link to Overview")
---------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/importprivkey#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importprivkey\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"importprivkey","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importprivkey\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importprivkey#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/importprivkey#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
importmulti](/naas-api/bitcoin/Methods/importmulti)[Next

importprunedfunds](/naas-api/bitcoin/Methods/importprunedfunds)

* [Overview](/naas-api/bitcoin/Methods/importprivkey#overview)
* [Request](/naas-api/bitcoin/Methods/importprivkey#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importprivkey#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importprivkey#response)
