getrawchangeaddress | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getrawchangeaddress)
...
Overview[​](/naas-api/bitcoin/Methods/getrawchangeaddress#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getrawchangeaddress#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getrawchangeaddress\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getrawchangeaddress","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getrawchangeaddress\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getrawchangeaddress#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------

* **address\_type** (string, optional): The type of address to generate. The options available are "legacy", "p2sh-segwit", and "bech32". The default value is set by the -changetype parameter.

Response[​](/naas-api/bitcoin/Methods/getrawchangeaddress#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
getpeerinfo](/naas-api/bitcoin/Methods/getpeerinfo)[Next

getrawmempool](/naas-api/bitcoin/Methods/getrawmempool)

* [Overview](/naas-api/bitcoin/Methods/getrawchangeaddress#overview)
* [Request](/naas-api/bitcoin/Methods/getrawchangeaddress#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getrawchangeaddress#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getrawchangeaddress#response)
