createmultisig | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/createmultisig_x)
...
Overview[​](/naas-api/bitcoin/Methods/createmultisig_x#overview "Direct link to Overview")
------------------------------------------------------------------------------------------

The **'createmultisig'** method creates a multi-signature address with n signature of m keys required.

Request[​](/naas-api/bitcoin/Methods/createmultisig_x#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/createmultisig_x#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------
...
* **address\_type** (string, optional, default=legacy): The address type to use. Options are “legacy”, “p2sh-segwit”, and “bech32”.

Response[​](/naas-api/bitcoin/Methods/createmultisig_x#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
combineRawTransaction](/naas-api/bitcoin/Methods/combinerawtransaction_x)[Next

createpsbt](/naas-api/bitcoin/Methods/createpsbt_x)

* [Overview](/naas-api/bitcoin/Methods/createmultisig_x#overview)
* [Request](/naas-api/bitcoin/Methods/createmultisig_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/createmultisig_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/createmultisig_x#response)
