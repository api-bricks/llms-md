finalizepsbt | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/finalizepsbt)
...
Request Parameters[​](/naas-api/bitcoin/Methods/finalizepsbt#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

* **psbt** (string, required): A base64 string of a PSBT.

Response[​](/naas-api/bitcoin/Methods/finalizepsbt#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
estimatesmartfee](/naas-api/bitcoin/Methods/estimatesmartfee)[Next

fundrawtransaction](/naas-api/bitcoin/Methods/fundrawtransaction)

* [Overview](/naas-api/bitcoin/Methods/finalizepsbt#overview)
* [Request](/naas-api/bitcoin/Methods/finalizepsbt#request)
* [Request Parameters](/naas-api/bitcoin/Methods/finalizepsbt#request-parameters)
* [Response](/naas-api/bitcoin/Methods/finalizepsbt#response)
