getdifficulty | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getdifficulty)
...
Overview[​](/naas-api/bitcoin/Methods/getdifficulty#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'getdifficulty'** RPC Method returns the proof-of-work difficulty as a multiple of the minimum difficulty.

Request[​](/naas-api/bitcoin/Methods/getdifficulty#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getdifficulty\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getdifficulty","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getdifficulty#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getdifficulty#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
**result**: The proof-of-work difficulty, represented as a multiple of the minimum difficulty.
**error**: A message describing the error, if any occurs during the process.
...
getconnectioncount](/naas-api/bitcoin/Methods/getconnectioncount)[Next

getindexinfo](/naas-api/bitcoin/Methods/getindexinfo)

* [Overview](/naas-api/bitcoin/Methods/getdifficulty#overview)
* [Request](/naas-api/bitcoin/Methods/getdifficulty#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getdifficulty#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getdifficulty#response)
