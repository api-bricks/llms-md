...
[Products](/naas-api/bitcoin/Methods/createpsbt_x)
...
Overview[​](/naas-api/bitcoin/Methods/createpsbt_x#overview "Direct link to Overview")
--------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/createpsbt_x#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
myHeaders.append("X-CoinAPI-Key", "73034021-THIS-IS-SAMPLE-KEY");  
...
fetch("https://bitcoin-mainnet.node.coinapi.io", requestOptions)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/createpsbt_x#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/createpsbt_x#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
createmultisig](/naas-api/bitcoin/Methods/createmultisig_x)[Next

createrawtransaction](/naas-api/bitcoin/Methods/createrawtransaction_x)

* [Overview](/naas-api/bitcoin/Methods/createpsbt_x#overview)
* [Request](/naas-api/bitcoin/Methods/createpsbt_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/createpsbt_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/createpsbt_x#response)
