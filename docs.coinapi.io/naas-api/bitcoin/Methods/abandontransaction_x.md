abandontransaction | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/abandontransaction_x)
...
Overview[​](/naas-api/bitcoin/Methods/abandontransaction_x#overview "Direct link to Overview")
----------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/abandontransaction_x#request "Direct link to Request")
-------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/abandontransaction_x#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------------

* **txid**: The transaction id

Response[​](/naas-api/bitcoin/Methods/abandontransaction_x#response "Direct link to Response")
----------------------------------------------------------------------------------------------
...
Bitcoin](/naas-api/bitcoin/)[Next

abortrescan](/naas-api/bitcoin/Methods/abortrescan_x)

* [Overview](/naas-api/bitcoin/Methods/abandontransaction_x#overview)
* [Request](/naas-api/bitcoin/Methods/abandontransaction_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/abandontransaction_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/abandontransaction_x#response)
