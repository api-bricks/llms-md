fundrawtransaction | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/fundrawtransaction)
...
Overview[​](/naas-api/bitcoin/Methods/fundrawtransaction#overview "Direct link to Overview")
--------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/fundrawtransaction#request "Direct link to Request")
-----------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/fundrawtransaction#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------------

* **hexstring** (string, required): The hex string of the raw transaction.
* **options** (json object, optional): Additional options for the transaction. Can include fields like "replaceable", "conf\_target", and "estimate\_mode".
...
Response[​](/naas-api/bitcoin/Methods/fundrawtransaction#response "Direct link to Response")
--------------------------------------------------------------------------------------------
...
finalizepsbt](/naas-api/bitcoin/Methods/finalizepsbt)[Next

generateBlock](/naas-api/bitcoin/Methods/generateblock)

* [Overview](/naas-api/bitcoin/Methods/fundrawtransaction#overview)
* [Request](/naas-api/bitcoin/Methods/fundrawtransaction#request)
* [Request Parameters](/naas-api/bitcoin/Methods/fundrawtransaction#request-parameters)
* [Response](/naas-api/bitcoin/Methods/fundrawtransaction#response)
