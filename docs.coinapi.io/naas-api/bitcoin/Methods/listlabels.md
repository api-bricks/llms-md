listlabels | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/listlabels)
...
Overview[​](/naas-api/bitcoin/Methods/listlabels#overview "Direct link to Overview")
------------------------------------------------------------------------------------

The **'listlabels'** Returns the list of all labels, or labels that are assigned to addresses with a specific purpose.

Request[​](/naas-api/bitcoin/Methods/listlabels#request "Direct link to Request")
---------------------------------------------------------------------------------
...
wget --no-check-certificate --quiet \  
  ...
  --body-data '{"jsonrpc":"2.0","id":1,"method":"listlabels","params": [ ]}' \  
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"listlabels\",\"params\": [],\"id\":1}", null, "application/json");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/listlabels#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------

* **purpose**: Address purpose to list labels for (‘send’,’receive’). An empty string is the same as not providing this argument.

Response[​](/naas-api/bitcoin/Methods/listlabels#response "Direct link to Response")
------------------------------------------------------------------------------------
...
listbanned](/naas-api/bitcoin/Methods/listbanned)[Next

listlockunspent](/naas-api/bitcoin/Methods/listlockunspent)

* [Overview](/naas-api/bitcoin/Methods/listlabels#overview)
* [Request](/naas-api/bitcoin/Methods/listlabels#request)
* [Request Parameters](/naas-api/bitcoin/Methods/listlabels#request-parameters)
* [Response](/naas-api/bitcoin/Methods/listlabels#response)
