...
[Products](/naas-api/bitcoin/Methods/createwallet_x)
...
Overview[​](/naas-api/bitcoin/Methods/createwallet_x#overview "Direct link to Overview")
----------------------------------------------------------------------------------------

The **'createwallet'** creates and loads a new wallet.

Request[​](/naas-api/bitcoin/Methods/createwallet_x#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/createwallet_x#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------

* **wallet\_name** (string, required): The name for the new wallet. If this is a path, the wallet will be created at the path location.
* **disable\_private\_keys** (boolean, optional, default=false): Disable the possibility of private keys (only watchonlys are possible in this mode).
...
* **avoid\_reuse** (boolean, optional, default=false): Keep track of coin reuse, and treat dirty and clean coins differently with privacy considerations in mind.
...
* **load\_on\_startup** (boolean, optional, default=null): Save wallet name to persistent settings and load on startup. True to add wallet to startup list, false to remove, null to leave unchanged.

Response[​](/naas-api/bitcoin/Methods/createwallet_x#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
createrawtransaction](/naas-api/bitcoin/Methods/createrawtransaction_x)[Next

decodeRawTransaction](/naas-api/bitcoin/Methods/decodeRawTransaction)

* [Overview](/naas-api/bitcoin/Methods/createwallet_x#overview)
* [Request](/naas-api/bitcoin/Methods/createwallet_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/createwallet_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/createwallet_x#response)
