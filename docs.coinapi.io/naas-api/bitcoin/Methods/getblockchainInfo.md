getblockchaininfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getblockchainInfo)
...
Overview[​](/naas-api/bitcoin/Methods/getblockchainInfo#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getblockchainInfo#request "Direct link to Request")
----------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getblockchainInfo\",\"params\": [],\"id\":1}", null, "application/json");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getblockchainInfo#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getblockchainInfo#response "Direct link to Response")
-------------------------------------------------------------------------------------------
...
* **size\_on\_disk**: An estimation of the combined size of the block and undo files stored on the disk.
...
getblock](/naas-api/bitcoin/Methods/getblock)[Next

getblockcount](/naas-api/bitcoin/Methods/getblockcount)

* [Overview](/naas-api/bitcoin/Methods/getblockchainInfo#overview)
* [Request](/naas-api/bitcoin/Methods/getblockchainInfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getblockchainInfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getblockchainInfo#response)
