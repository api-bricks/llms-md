gettxout | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/gettxout)
...
Overview[​](/naas-api/bitcoin/Methods/gettxout#overview "Direct link to Overview")
----------------------------------------------------------------------------------

The **'gettxout'** RPC method allows you to retrieve details about an unspent transaction output in the Bitcoin network

Request[​](/naas-api/bitcoin/Methods/gettxout#request "Direct link to Request")
-------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/gettxout#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/gettxout#response "Direct link to Response")
----------------------------------------------------------------------------------
...
gettransaction](/naas-api/bitcoin/Methods/gettransaction)[Next

gettxoutproof](/naas-api/bitcoin/Methods/gettxoutproof)

* [Overview](/naas-api/bitcoin/Methods/gettxout#overview)
* [Request](/naas-api/bitcoin/Methods/gettxout#request)
* [Request Parameters](/naas-api/bitcoin/Methods/gettxout#request-parameters)
* [Response](/naas-api/bitcoin/Methods/gettxout#response)
