deriveaddresses | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/deriveaddresses)
...
Overview[​](/naas-api/bitcoin/Methods/deriveaddresses#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **'deriveaddresses'** method derives one or more addresses corresponding to an output descriptor.

Request[​](/naas-api/bitcoin/Methods/deriveaddresses#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/deriveaddresses#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/deriveaddresses#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
Decodescript](/naas-api/bitcoin/Methods/decodescript)[Next

disconnectnode](/naas-api/bitcoin/Methods/disconnectnode)

* [Overview](/naas-api/bitcoin/Methods/deriveaddresses#overview)
* [Request](/naas-api/bitcoin/Methods/deriveaddresses#request)
* [Request Parameters](/naas-api/bitcoin/Methods/deriveaddresses#request-parameters)
* [Response](/naas-api/bitcoin/Methods/deriveaddresses#response)
