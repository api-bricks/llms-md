getnetworkhashps | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getnetworkhashps)
...
Overview[​](/naas-api/bitcoin/Methods/getnetworkhashps#overview "Direct link to Overview")
------------------------------------------------------------------------------------------

The **'getnetworkhashps'** method returns the estimated network hashes per second based on the last n blocks.

Request[​](/naas-api/bitcoin/Methods/getnetworkhashps#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
wget --no-check-certificate --quiet \  
  ...
  --body-data '{"jsonrpc":"2.0","id":1,"method":"getnetworkhashps","params": [ ]}' \  
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnetworkhashps\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getnetworkhashps","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getnetworkhashps\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getnetworkhashps#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getnetworkhashps#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
getnettotals](/naas-api/bitcoin/Methods/getnettotals)[Next

getnetworkinfo](/naas-api/bitcoin/Methods/getnetworkinfo)

* [Overview](/naas-api/bitcoin/Methods/getnetworkhashps#overview)
* [Request](/naas-api/bitcoin/Methods/getnetworkhashps#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getnetworkhashps#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getnetworkhashps#response)
