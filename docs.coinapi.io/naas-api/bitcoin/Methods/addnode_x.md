addnode | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/addnode_x)
...
Overview[​](/naas-api/bitcoin/Methods/addnode_x#overview "Direct link to Overview")
-----------------------------------------------------------------------------------

The **'addnode'** attempts to add or remove a node from the addnode list

Request[​](/naas-api/bitcoin/Methods/addnode_x#request "Direct link to Request")
--------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"addnode\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"addnode","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/addnode_x#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/addnode_x#response "Direct link to Response")
-----------------------------------------------------------------------------------
...
abortrescan](/naas-api/bitcoin/Methods/abortrescan_x)[Next

analyzepsbt](/naas-api/bitcoin/Methods/analyzepsbt_x)

* [Overview](/naas-api/bitcoin/Methods/addnode_x#overview)
* [Request](/naas-api/bitcoin/Methods/addnode_x#request)
* [Request Parameters](/naas-api/bitcoin/Methods/addnode_x#request-parameters)
* [Response](/naas-api/bitcoin/Methods/addnode_x#response)
