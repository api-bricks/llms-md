importwallet | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importwallet)
...
Overview[​](/naas-api/bitcoin/Methods/importwallet#overview "Direct link to Overview")
--------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/importwallet#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"importwallet\",\"params\": [],\"id\":1}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","method":"importwallet","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importwallet#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

* **filename**: The wallet file

Response[​](/naas-api/bitcoin/Methods/importwallet#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
importpubkey](/naas-api/bitcoin/Methods/importpubkey)[Next

keypoolrefill](/naas-api/bitcoin/Methods/keypoolrefill)

* [Overview](/naas-api/bitcoin/Methods/importwallet#overview)
* [Request](/naas-api/bitcoin/Methods/importwallet#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importwallet#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importwallet#response)
