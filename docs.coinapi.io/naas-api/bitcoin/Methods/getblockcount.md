getblockcount | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getblockcount)
...
Overview[​](/naas-api/bitcoin/Methods/getblockcount#overview "Direct link to Overview")
---------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getblockcount#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getblockcount\",\"params\": [],\"id\":1}", null, "application/json");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getblockcount#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getblockcount#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
getblockchaininfo](/naas-api/bitcoin/Methods/getblockchainInfo)[Next

getblockfilter](/naas-api/bitcoin/Methods/getblockfilter)

* [Overview](/naas-api/bitcoin/Methods/getblockcount#overview)
* [Request](/naas-api/bitcoin/Methods/getblockcount#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getblockcount#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getblockcount#response)
