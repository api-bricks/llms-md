dumpprivkey | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/dumpprivkey)
...
Overview[​](/naas-api/bitcoin/Methods/dumpprivkey#overview "Direct link to Overview")
-------------------------------------------------------------------------------------

The **'dumpprivkey'** Reveals the private key corresponding to ‘address’.

Request[​](/naas-api/bitcoin/Methods/dumpprivkey#request "Direct link to Request")
----------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/dumpprivkey#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------

* **address**: The bitcoin address for the private key

Response[​](/naas-api/bitcoin/Methods/dumpprivkey#response "Direct link to Response")
-------------------------------------------------------------------------------------
...
disconnectnode](/naas-api/bitcoin/Methods/disconnectnode)[Next

estimatesmartfee](/naas-api/bitcoin/Methods/estimatesmartfee)

* [Overview](/naas-api/bitcoin/Methods/dumpprivkey#overview)
* [Request](/naas-api/bitcoin/Methods/dumpprivkey#request)
* [Request Parameters](/naas-api/bitcoin/Methods/dumpprivkey#request-parameters)
* [Response](/naas-api/bitcoin/Methods/dumpprivkey#response)
