...
[Products](/naas-api/bitcoin/Methods/getchaintips)
...
Overview[​](/naas-api/bitcoin/Methods/getchaintips#overview "Direct link to Overview")
--------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/getchaintips#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/getchaintips#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

This method does not require any parameters.

Response[​](/naas-api/bitcoin/Methods/getchaintips#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
* **valid-header**s: This status is assigned when the branch contains all blocks, but they haven't been fully validated.
...
getblocktemplate](/naas-api/bitcoin/Methods/getblocktemplate)[Next

getchaintxstats](/naas-api/bitcoin/Methods/getchaintxstats)

* [Overview](/naas-api/bitcoin/Methods/getchaintips#overview)
* [Request](/naas-api/bitcoin/Methods/getchaintips#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getchaintips#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getchaintips#response)
