importAddress | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importaddress)
...
Overview[​](/naas-api/bitcoin/Methods/importaddress#overview "Direct link to Overview")
---------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/importaddress#request "Direct link to Request")
------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importAddress\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"importAddress","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importAddress\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importaddress#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/importaddress#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
help](/naas-api/bitcoin/Methods/help)[Next

import\_descriptors](/naas-api/bitcoin/Methods/importdescriptors)

* [Overview](/naas-api/bitcoin/Methods/importaddress#overview)
* [Request](/naas-api/bitcoin/Methods/importaddress#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importaddress#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importaddress#response)
