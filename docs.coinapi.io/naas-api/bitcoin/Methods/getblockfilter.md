...
[Products](/naas-api/bitcoin/Methods/getblockfilter)
...
Overview[​](/naas-api/bitcoin/Methods/getblockfilter#overview "Direct link to Overview")
----------------------------------------------------------------------------------------

The **'getblockfilter'** method allows you to retrieve a BIP 157 content filter for a specific block in the Bitcoin blockchain.

Request[​](/naas-api/bitcoin/Methods/getblockfilter#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getblockfilter\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getblockfilter","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getblockfilter#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getblockfilter#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
getblockcount](/naas-api/bitcoin/Methods/getblockcount)[Next

getblockhash](/naas-api/bitcoin/Methods/getblockhash)

* [Overview](/naas-api/bitcoin/Methods/getblockfilter#overview)
* [Request](/naas-api/bitcoin/Methods/getblockfilter#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getblockfilter#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getblockfilter#response)
