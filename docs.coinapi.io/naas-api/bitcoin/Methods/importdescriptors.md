import\_descriptors | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importdescriptors)
...
Overview[​](/naas-api/bitcoin/Methods/importdescriptors#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------

The **'import\_descriptors'** method allows you to import descriptors to the CoinAPI. This method is essential for managing various aspects of your Bitcoin transactions and wallet functionalities through the CoinAPI.

Request[​](/naas-api/bitcoin/Methods/importdescriptors#request "Direct link to Request")
----------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"import_descriptors\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"import_descriptors","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"import_descriptors\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importdescriptors#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------
...
* **next\_index**: If a ranged descriptor is set to active, this specifies the next index to generate addresses from. This is an optional parameter.
...
Response[​](/naas-api/bitcoin/Methods/importdescriptors#response "Direct link to Response")
-------------------------------------------------------------------------------------------
...
importAddress](/naas-api/bitcoin/Methods/importaddress)[Next

importmulti](/naas-api/bitcoin/Methods/importmulti)

* [Overview](/naas-api/bitcoin/Methods/importdescriptors#overview)
* [Request](/naas-api/bitcoin/Methods/importdescriptors#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importdescriptors#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importdescriptors#response)
