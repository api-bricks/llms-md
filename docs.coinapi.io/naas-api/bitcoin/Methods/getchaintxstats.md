getchaintxstats | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getchaintxstats)
...
Overview[​](/naas-api/bitcoin/Methods/getchaintxstats#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **'getchaintxstats'** method returns the current client version.

Request[​](/naas-api/bitcoin/Methods/getchaintxstats#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getchaintxstats\",\"params\": [],\"id\":1}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getchaintxstats","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getchaintxstats#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/bitcoin/Methods/getchaintxstats#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
getchaintips](/naas-api/bitcoin/Methods/getchaintips)[Next

getconnectioncount](/naas-api/bitcoin/Methods/getconnectioncount)

* [Overview](/naas-api/bitcoin/Methods/getchaintxstats#overview)
* [Request](/naas-api/bitcoin/Methods/getchaintxstats#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getchaintxstats#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getchaintxstats#response)
