getbalance | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getbalance)
...
Overview[​](/naas-api/bitcoin/Methods/getbalance#overview "Direct link to Overview")
------------------------------------------------------------------------------------

The **'getbalance'** Returns the total available balance.

Request[​](/naas-api/bitcoin/Methods/getbalance#request "Direct link to Request")
---------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getbalance\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getbalance","params": [],"id":1}`)  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getbalance#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------
...
* **include\_watchonly**: Also include balance in watch-only addresses (see ‘importaddress’)
* **avoid\_reuse**: (only available if avoid\_reuse wallet flag is set) Do not include balance in dirty outputs; addresses are considered dirty if they have previously been used in a transaction.

Response[​](/naas-api/bitcoin/Methods/getbalance#response "Direct link to Response")
------------------------------------------------------------------------------------
...
getaddressesbylabel](/naas-api/bitcoin/Methods/getaddressesbylabel)[Next

getbalances](/naas-api/bitcoin/Methods/getbalances)

* [Overview](/naas-api/bitcoin/Methods/getbalance#overview)
* [Request](/naas-api/bitcoin/Methods/getbalance#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getbalance#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getbalance#response)
