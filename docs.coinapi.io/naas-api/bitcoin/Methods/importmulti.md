importmulti | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/importmulti)
...
Overview[​](/naas-api/bitcoin/Methods/importmulti#overview "Direct link to Overview")
-------------------------------------------------------------------------------------
...
Request[​](/naas-api/bitcoin/Methods/importmulti#request "Direct link to Request")
----------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importmulti\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"importmulti","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"importmulti\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/importmulti#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/importmulti#response "Direct link to Response")
-------------------------------------------------------------------------------------
...
import\_descriptors](/naas-api/bitcoin/Methods/importdescriptors)[Next

importprivkey](/naas-api/bitcoin/Methods/importprivkey)

* [Overview](/naas-api/bitcoin/Methods/importmulti#overview)
* [Request](/naas-api/bitcoin/Methods/importmulti#request)
* [Request Parameters](/naas-api/bitcoin/Methods/importmulti#request-parameters)
* [Response](/naas-api/bitcoin/Methods/importmulti#response)
