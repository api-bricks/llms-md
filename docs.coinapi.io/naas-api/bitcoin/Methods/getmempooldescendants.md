getmempooldescendants | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getmempooldescendants)
...
Overview[​](/naas-api/bitcoin/Methods/getmempooldescendants#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------------

The **'getmempooldescendants'** RPC Method returns all in-mempool descendants for a transaction in the mempool.

Request[​](/naas-api/bitcoin/Methods/getmempooldescendants#request "Direct link to Request")
--------------------------------------------------------------------------------------------
...
wget --no-check-certificate --quiet \  
  ...
  --body-data '{"jsonrpc":"2.0","method":"getmempooldescendants","params": [],"id":1}' \  
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"method\":\"getmempooldescendants\",\"params\": [],\"id\":1}", null, "application/json");  
...
func main() {  
  ...
  payload := strings.NewReader(`{"jsonrpc":"2.0","method":"getmempooldescendants","params": [],"id":1}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"method\":\"getmempooldescendants\",\"params\": [],\"id\":1}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getmempooldescendants#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------------

**txid** (string, required): The transaction id, and it must be in mempool
**verbose** (string): default=false. It's true for a JSON object and false for array of transaction ids

Response[​](/naas-api/bitcoin/Methods/getmempooldescendants#response "Direct link to Response")
-----------------------------------------------------------------------------------------------
...
**unbroadcast**: Whether this transaction is currently unbroadcast (initial broadcast not yet acknowledged by any peers)
...
getmempoolancestors](/naas-api/bitcoin/Methods/getmempoolancestors)[Next

getmempoolentry](/naas-api/bitcoin/Methods/getmempoolentry)

* [Overview](/naas-api/bitcoin/Methods/getmempooldescendants#overview)
* [Request](/naas-api/bitcoin/Methods/getmempooldescendants#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getmempooldescendants#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getmempooldescendants#response)
