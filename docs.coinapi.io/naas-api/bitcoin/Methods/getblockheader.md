...
[Products](/naas-api/bitcoin/Methods/getblockheader)
...
Overview[​](/naas-api/bitcoin/Methods/getblockheader#overview "Direct link to Overview")
----------------------------------------------------------------------------------------

The \*\*'getblockheader'\*\*PC method allows you to retrieve the header of a specific block using its hash.

Request[​](/naas-api/bitcoin/Methods/getblockheader#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/bitcoin/Methods/getblockheader#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/bitcoin/Methods/getblockheader#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
getblockhash](/naas-api/bitcoin/Methods/getblockhash)[Next

getblockstats](/naas-api/bitcoin/Methods/getblockstats)

* [Overview](/naas-api/bitcoin/Methods/getblockheader#overview)
* [Request](/naas-api/bitcoin/Methods/getblockheader#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getblockheader#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getblockheader#response)
