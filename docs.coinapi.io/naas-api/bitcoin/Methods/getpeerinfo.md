getpeerinfo | CoinAPI.io Documentation
...
[Products](/naas-api/bitcoin/Methods/getpeerinfo)
...
Overview[​](/naas-api/bitcoin/Methods/getpeerinfo#overview "Direct link to Overview")
-------------------------------------------------------------------------------------

The **'getpeerinfo'** method returns the estimated network hashes per second based on the last n blocks.

Request[​](/naas-api/bitcoin/Methods/getpeerinfo#request "Direct link to Request")
----------------------------------------------------------------------------------
...
var content = new StringContent("{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getpeerinfo\",\"params\": [ ]}", null, "application/json");  
...
payload := strings.NewReader(`{"jsonrpc":"2.0","id":1,"method":"getpeerinfo","params": [ ]}`)  
...
RequestBody body = RequestBody.create(mediaType, "{\"jsonrpc\":\"2.0\",\"id\":1,\"method\":\"getpeerinfo\",\"params\": [ ]}");  
...
Request Parameters[​](/naas-api/bitcoin/Methods/getpeerinfo#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/bitcoin/Methods/getpeerinfo#response "Direct link to Response")
-------------------------------------------------------------------------------------
...
getnodeaddresses](/naas-api/bitcoin/Methods/getnodeaddresses)[Next

getrawchangeaddress](/naas-api/bitcoin/Methods/getrawchangeaddress)

* [Overview](/naas-api/bitcoin/Methods/getpeerinfo#overview)
* [Request](/naas-api/bitcoin/Methods/getpeerinfo#request)
* [Request Parameters](/naas-api/bitcoin/Methods/getpeerinfo#request-parameters)
* [Response](/naas-api/bitcoin/Methods/getpeerinfo#response)
