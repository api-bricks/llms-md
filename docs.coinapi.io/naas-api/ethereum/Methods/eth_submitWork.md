eth\_submitWork | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_submitWork)
...
Overview[​](/naas-api/ethereum/Methods/eth_submitWork#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **"eth\_submitWork"** is used for submitting a proof-of-work solution.

Request[​](/naas-api/ethereum/Methods/eth_submitWork#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_submitWork\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_submitWork'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_submitWork\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_submitWork\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_submitWork\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_submitWork#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/eth_submitWork#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
eth\_signTransaction](/naas-api/ethereum/Methods/eth_signTransaction)[Next

eth\_subscribe](/naas-api/ethereum/Methods/eth_subscribe)

* [Overview](/naas-api/ethereum/Methods/eth_submitWork#overview)
* [Request](/naas-api/ethereum/Methods/eth_submitWork#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_submitWork#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_submitWork#response)
