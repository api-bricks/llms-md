...
[Products](/naas-api/ethereum/Methods/getTxPoolStatus)
...
Overview[​](/naas-api/ethereum/Methods/getTxPoolStatus#overview "Direct link to Overview")
------------------------------------------------------------------------------------------

The **'getTxPoolStatus'** method provides information about the current status of the Ethereum transaction pool.

Request[​](/naas-api/ethereum/Methods/getTxPoolStatus#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/getTxPoolStatus#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/getTxPoolStatus#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
getBlockByRoot](/naas-api/ethereum/Methods/getBlockByRoot)[Next

net\_listening](/naas-api/ethereum/Methods/net_listening)

* [Overview](/naas-api/ethereum/Methods/getTxPoolStatus#overview)
* [Request](/naas-api/ethereum/Methods/getTxPoolStatus#request)
* [Request Parameters](/naas-api/ethereum/Methods/getTxPoolStatus#request-parameters)
* [Response](/naas-api/ethereum/Methods/getTxPoolStatus#response)
