txpool\_content | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/txpool_content)
...
Overview[​](/naas-api/ethereum/Methods/txpool_content#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **'txpool\_content'** method provides information about the current state of the Ethereum transaction pool. It returns the transactions that are currently pending (waiting to be mined) and queued (waiting for a suitable nonce) in the Ethereum network.

Request[​](/naas-api/ethereum/Methods/txpool_content#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/txpool_content#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------

* **method**: The name of the method being called, in this case, "txpool\_content".
* **params**: An array of parameters to pass to the method. For "txpool\_content", this is typically an empty array.
* **id**: A unique identifier for the request.
* **jsonrpc**: The version of the JSON-RPC protocol being used, typically "2.0" for Ethereum.

Response[​](/naas-api/ethereum/Methods/txpool_content#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
trace\_transaction](/naas-api/ethereum/Methods/trace_transaction)[Next

txpool\_contentFrom](/naas-api/ethereum/Methods/txpool_contentFrom)

* [Overview](/naas-api/ethereum/Methods/txpool_content#overview)
* [Request](/naas-api/ethereum/Methods/txpool_content#request)
* [Request Parameters](/naas-api/ethereum/Methods/txpool_content#request-parameters)
* [Response](/naas-api/ethereum/Methods/txpool_content#response)
