net\_version | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/net_version)
...
Overview[​](/naas-api/ethereum/Methods/net_version#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **'net\_version'** returns the current network ID.

Request[​](/naas-api/ethereum/Methods/net_version#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
using RestSharp; {  
      ...
      request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_version\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_version\"}")  
...
request.body = {\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_version\"}  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_version\"}");  
...
Response[​](/naas-api/ethereum/Methods/net_version#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
net\_peerCount](/naas-api/ethereum/Methods/net_peerCount)[Next

trace\_block](/naas-api/ethereum/Methods/trace_block)

* [Overview](/naas-api/ethereum/Methods/net_version#overview)
* [Request](/naas-api/ethereum/Methods/net_version#request)
* [Response](/naas-api/ethereum/Methods/net_version#response)
