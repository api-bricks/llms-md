...
[Products](/naas-api/ethereum/Methods/getBeaconBlocksAttestations)
...
Overview[​](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#overview "Direct link to Overview")
------------------------------------------------------------------------------------------------------

The **'getBeaconBlocksAttestations'** method retrieves attestations for a specified beacon block in the Ethereum blockchain.

Request[​](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#request "Direct link to Request")
---------------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------------------

* **'block\_id'**: The unique identifier for the beacon block for which you want to retrieve attestations.

Response[​](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#response "Direct link to Response")
------------------------------------------------------------------------------------------------------
...
eth\_unsubscribe](/naas-api/ethereum/Methods/eth_unsubscribe)[Next

getBlockByRoot](/naas-api/ethereum/Methods/getBlockByRoot)

* [Overview](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#overview)
* [Request](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#request)
* [Request Parameters](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#request-parameters)
* [Response](/naas-api/ethereum/Methods/getBeaconBlocksAttestations#response)
