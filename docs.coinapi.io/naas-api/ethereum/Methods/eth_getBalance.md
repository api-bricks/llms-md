eth\_createAccessList | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getBalance)
...
Overview[​](/naas-api/ethereum/Methods/eth_getBalance#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------

The **'eth\_getBalance'** method returns the balance of the specified address in wei.

Request[​](/naas-api/ethereum/Methods/eth_getBalance#request "Direct link to Request")
--------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getBalance#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_getBalance#response "Direct link to Response")
-----------------------------------------------------------------------------------------
...
eth\_gasPrice](/naas-api/ethereum/Methods/eth_gasPrice)[Next

eth\_getBlockByHash](/naas-api/ethereum/Methods/eth_getBlockByHash)

* [Overview](/naas-api/ethereum/Methods/eth_getBalance#overview)
* [Request](/naas-api/ethereum/Methods/eth_getBalance#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getBalance#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getBalance#response)
