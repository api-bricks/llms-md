trace\_call | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/trace_call)
...
Overview[​](/naas-api/ethereum/Methods/trace_call#overview "Direct link to Overview")
-------------------------------------------------------------------------------------

The **'trace\_call'** method allows you to simulate a call transaction without actually executing it. This can be useful for debugging and understanding the potential outcome of a transaction.

Request[​](/naas-api/ethereum/Methods/trace_call#request "Direct link to Request")
----------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/trace_call#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/trace_call#response "Direct link to Response")
-------------------------------------------------------------------------------------
...
Errors[​](/naas-api/ethereum/Methods/trace_call#errors "Direct link to Errors")
-------------------------------------------------------------------------------
...
Rate Limits[​](/naas-api/ethereum/Methods/trace_call#rate-limits "Direct link to Rate Limits")
----------------------------------------------------------------------------------------------
...
Support[​](/naas-api/ethereum/Methods/trace_call#support "Direct link to Support")
----------------------------------------------------------------------------------

If you encounter any issues or have further questions regarding the eth\_getBlockByHash method, please contact our support team at **[[email protected]](/cdn-cgi/l/email-protection#681b1d1818071a1c280b070106091801460107)**.
...
trace\_block](/naas-api/ethereum/Methods/trace_block)[Next

trace\_callMany](/naas-api/ethereum/Methods/trace_callMany)

* [Overview](/naas-api/ethereum/Methods/trace_call#overview)
* [Request](/naas-api/ethereum/Methods/trace_call#request)
* [Request Parameters](/naas-api/ethereum/Methods/trace_call#request-parameters)
* [Response](/naas-api/ethereum/Methods/trace_call#response)
* [Errors](/naas-api/ethereum/Methods/trace_call#errors)
* [Rate Limits](/naas-api/ethereum/Methods/trace_call#rate-limits)
* [Support](/naas-api/ethereum/Methods/trace_call#support)
