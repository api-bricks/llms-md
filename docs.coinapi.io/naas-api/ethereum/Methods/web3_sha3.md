web3\_sha3 | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/web3_sha3)
...
Overview[​](/naas-api/ethereum/Methods/web3_sha3#overview "Direct link to Overview")
------------------------------------------------------------------------------------

The **'web3\_sha3'** returns Keccak-256 (not the standardized SHA3-256) of the given data.

Request[​](/naas-api/ethereum/Methods/web3_sha3#request "Direct link to Request")
---------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_sha3\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'web3_sha3'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_sha3\"}")  
...
request.body = {\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_sha3\"}  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_sha3\"}");  
...
Response[​](/naas-api/ethereum/Methods/web3_sha3#response "Direct link to Response")
------------------------------------------------------------------------------------
...
* [Overview](/naas-api/ethereum/Methods/web3_sha3#overview)
* [Request](/naas-api/ethereum/Methods/web3_sha3#request)
* [Response](/naas-api/ethereum/Methods/web3_sha3#response)
