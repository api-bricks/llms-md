eth\_syncing | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_syncing)
...
Overview[​](/naas-api/ethereum/Methods/eth_syncing#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **"eth\_syncing"** returns an object with data about the sync status or false.

Request[​](/naas-api/ethereum/Methods/eth_syncing#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_syncing\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_syncing'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_syncing\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_syncing\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_syncing\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_syncing#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/eth_syncing#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
subscribePendingTransactions](/naas-api/ethereum/Methods/eth_subscribePendingTransactions)[Next

eth\_uninstallFilter](/naas-api/ethereum/Methods/eth_uninstallFilter)

* [Overview](/naas-api/ethereum/Methods/eth_syncing#overview)
* [Request](/naas-api/ethereum/Methods/eth_syncing#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_syncing#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_syncing#response)
