eth\_getFilterChanges | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getFilterChanges)
...
Overview[​](/naas-api/ethereum/Methods/eth_getFilterChanges#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------------

Polling method for a filter, which returns an array of logs that occurred since the last poll. The filter must be created by calling either **'eth\_newFilter'** or **'eth\_newBlockFilter'**.

Request[​](/naas-api/ethereum/Methods/eth_getFilterChanges#request "Direct link to Request")
--------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getFilterChanges#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------------

* **'filter ID'**: A string denoting the filter ID.

Response[​](/naas-api/ethereum/Methods/eth_getFilterChanges#response "Direct link to Response")
-----------------------------------------------------------------------------------------------
...
* For filters created with **'eth\_newBlockFilter'**, the return values are block hashes (32 bytes), e.g. **'["0x3454645634534..."]'**.
* For filters created with **'eth\_newFilter'**, the logs are objects with the following parameters:
...
eth\_getCode](/naas-api/ethereum/Methods/eth_getCode)[Next

eth\_getFilterLogs](/naas-api/ethereum/Methods/eth_getFilterLogs)

* [Overview](/naas-api/ethereum/Methods/eth_getFilterChanges#overview)
* [Request](/naas-api/ethereum/Methods/eth_getFilterChanges#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getFilterChanges#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getFilterChanges#response)
