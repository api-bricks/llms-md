net\_peerCount | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/net_peerCount)
...
Overview[​](/naas-api/ethereum/Methods/net_peerCount#overview "Direct link to Overview")
----------------------------------------------------------------------------------------

The **"net\_peerCount"** returns the number of peers currently connected to the client.

Request[​](/naas-api/ethereum/Methods/net_peerCount#request "Direct link to Request")
-------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'net_peerCount'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"net_peerCount\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/net_peerCount#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/net_peerCount#response "Direct link to Response")
----------------------------------------------------------------------------------------
...
net\_listening](/naas-api/ethereum/Methods/net_listening)[Next

net\_version](/naas-api/ethereum/Methods/net_version)

* [Overview](/naas-api/ethereum/Methods/net_peerCount#overview)
* [Request](/naas-api/ethereum/Methods/net_peerCount#request)
* [Request Parameters](/naas-api/ethereum/Methods/net_peerCount#request-parameters)
* [Response](/naas-api/ethereum/Methods/net_peerCount#response)
