eth\_gasPrice | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_gasPrice)
...
Overview[​](/naas-api/ethereum/Methods/eth_gasPrice#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'eth\_gasPrice'** method returns price per gas in wei currently.

Request[​](/naas-api/ethereum/Methods/eth_gasPrice#request "Direct link to Request")
------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_gasPrice\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_gasPrice\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_gasPrice\"}"  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_gasPrice#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

* None.

Response[​](/naas-api/ethereum/Methods/eth_gasPrice#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
eth\_feeHistory](/naas-api/ethereum/Methods/eth_feeHistory)[Next

eth\_createAccessList](/naas-api/ethereum/Methods/eth_getBalance)

* [Overview](/naas-api/ethereum/Methods/eth_gasPrice#overview)
* [Request](/naas-api/ethereum/Methods/eth_gasPrice#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_gasPrice#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_gasPrice#response)
