txpool\_contentFrom | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/txpool_contentFrom)
...
Overview[​](/naas-api/ethereum/Methods/txpool_contentFrom#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------

The **'txpool\_contentFrom'** method retrieves the transactions contained within the txpool. It returns both pending and queued transactions of a specific address, grouped by nonce.

Request[​](/naas-api/ethereum/Methods/txpool_contentFrom#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/txpool_contentFrom#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------

* **'address'**: The Ethereum address for which you want to retrieve the pending and queued transactions.

Response[​](/naas-api/ethereum/Methods/txpool_contentFrom#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
txpool\_content](/naas-api/ethereum/Methods/txpool_content)[Next

txpool\_inspect](/naas-api/ethereum/Methods/txpool_inspect)

* [Overview](/naas-api/ethereum/Methods/txpool_contentFrom#overview)
* [Request](/naas-api/ethereum/Methods/txpool_contentFrom#request)
* [Request Parameters](/naas-api/ethereum/Methods/txpool_contentFrom#request-parameters)
* [Response](/naas-api/ethereum/Methods/txpool_contentFrom#response)
