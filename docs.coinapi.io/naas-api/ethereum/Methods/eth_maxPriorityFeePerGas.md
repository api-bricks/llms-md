eth\_maxPriorityFeePerGas | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas)
...
Overview[​](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------------

The **'eth\_maxPriorityFeePerGas'** method returns an estimate of how much priority fee, in wei, you need to be included in a block.

Request[​](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#request "Direct link to Request")
------------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_maxPriorityFeePerGas\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_maxPriorityFeePerGas\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_maxPriorityFeePerGas\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_maxPriorityFeePerGas\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------------

* None.

Response[​](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#response "Direct link to Response")
---------------------------------------------------------------------------------------------------
...
eth\_hashrate](/naas-api/ethereum/Methods/eth_hashrate)[Next

eth\_mining](/naas-api/ethereum/Methods/eth_mining)

* [Overview](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#overview)
* [Request](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas#response)
