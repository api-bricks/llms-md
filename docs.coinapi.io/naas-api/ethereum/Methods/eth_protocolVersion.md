eth\_protocolVersion | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_protocolVersion)
...
Overview[​](/naas-api/ethereum/Methods/eth_protocolVersion#overview "Direct link to Overview")
----------------------------------------------------------------------------------------------

The **'eth\_protocolVersion'** method returns the current Ethereum protocol version.

Request[​](/naas-api/ethereum/Methods/eth_protocolVersion#request "Direct link to Request")
-------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_protocolVersion\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_protocolVersion'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_protocolVersion\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_protocolVersion\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_protocolVersion\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_protocolVersion#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------------

* None

Response[​](/naas-api/ethereum/Methods/eth_protocolVersion#response "Direct link to Response")
----------------------------------------------------------------------------------------------
...
eth\_newPendingTransactionFilter](/naas-api/ethereum/Methods/eth_newPendingTransactionFilter)[Next

eth\_sendRawTransaction](/naas-api/ethereum/Methods/eth_sendRawTransaction)

* [Overview](/naas-api/ethereum/Methods/eth_protocolVersion#overview)
* [Request](/naas-api/ethereum/Methods/eth_protocolVersion#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_protocolVersion#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_protocolVersion#response)
