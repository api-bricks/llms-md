trace\_rawTransaction | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/trace_rawTransaction)
...
Overview[​](/naas-api/ethereum/Methods/trace_rawTransaction#overview "Direct link to Overview")
-----------------------------------------------------------------------------------------------

The **'trace\_rawTransaction'** method allows users to retrieve internal transactions that occurred during the execution of a specific Ethereum transaction. This is particularly useful for understanding the internal operations of complex smart contract interactions.

Request[​](/naas-api/ethereum/Methods/trace_rawTransaction#request "Direct link to Request")
--------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/trace_rawTransaction#request-parameters "Direct link to Request Parameters")
-----------------------------------------------------------------------------------------------------------------------------

* **transaction\_hash**: The hash of the Ethereum transaction you want to trace.
* **api\_key**: Your CoinAPI API key.

Response[​](/naas-api/ethereum/Methods/trace_rawTransaction#response "Direct link to Response")
-----------------------------------------------------------------------------------------------
...
Errors[​](/naas-api/ethereum/Methods/trace_rawTransaction#errors "Direct link to Errors")
-----------------------------------------------------------------------------------------
...
Rate Limits[​](/naas-api/ethereum/Methods/trace_rawTransaction#rate-limits "Direct link to Rate Limits")
--------------------------------------------------------------------------------------------------------
...
Support[​](/naas-api/ethereum/Methods/trace_rawTransaction#support "Direct link to Support")
--------------------------------------------------------------------------------------------

If you encounter any issues or have further questions regarding the eth\_getBlockByHash method, please contact our support team at **[[email protected]](/cdn-cgi/l/email-protection#63101613130c111723000c0a0d02130a4d0a0c)**.
...
trace\_filter](/naas-api/ethereum/Methods/trace_filter)[Next

trace\_replayBlockTransactions](/naas-api/ethereum/Methods/trace_replayBlockTransactions)

* [Overview](/naas-api/ethereum/Methods/trace_rawTransaction#overview)
* [Request](/naas-api/ethereum/Methods/trace_rawTransaction#request)
* [Request Parameters](/naas-api/ethereum/Methods/trace_rawTransaction#request-parameters)
* [Response](/naas-api/ethereum/Methods/trace_rawTransaction#response)
* [Errors](/naas-api/ethereum/Methods/trace_rawTransaction#errors)
* [Rate Limits](/naas-api/ethereum/Methods/trace_rawTransaction#rate-limits)
* [Support](/naas-api/ethereum/Methods/trace_rawTransaction#support)
