eth\_sendRawTransaction | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_sendRawTransaction)
...
Overview[​](/naas-api/ethereum/Methods/eth_sendRawTransaction#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------------

The **'eth\_sendRawTransaction'** method submits a pre-signed transaction for broadcast to the Ethereum network.

Request[​](/naas-api/ethereum/Methods/eth_sendRawTransaction#request "Direct link to Request")
----------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_sendRawTransaction\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_sendRawTransaction\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_sendRawTransaction\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_sendRawTransaction\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_sendRawTransaction#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------------

* None

Response[​](/naas-api/ethereum/Methods/eth_sendRawTransaction#response "Direct link to Response")
-------------------------------------------------------------------------------------------------
...
* **eth\_getTransactionReceipt**: 32 bytes. to get the contract address, after the transaction was mined, when you created a contract.
...
eth\_protocolVersion](/naas-api/ethereum/Methods/eth_protocolVersion)[Next

eth\_sign](/naas-api/ethereum/Methods/eth_sign)

* [Overview](/naas-api/ethereum/Methods/eth_sendRawTransaction#overview)
* [Request](/naas-api/ethereum/Methods/eth_sendRawTransaction#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_sendRawTransaction#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_sendRawTransaction#response)
