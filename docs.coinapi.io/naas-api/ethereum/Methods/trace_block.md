trace\_block | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/trace_block)
...
Overview[​](/naas-api/ethereum/Methods/trace_block#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **"trace\_block"** gets trace information about all the transactions in a given block. This can be useful for debugging purposes or for analyzing the behavior of a blockchain

Request[​](/naas-api/ethereum/Methods/trace_block#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/trace_block#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/trace_block#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
Errors[​](/naas-api/ethereum/Methods/trace_block#errors "Direct link to Errors")
--------------------------------------------------------------------------------
...
Rate Limits[​](/naas-api/ethereum/Methods/trace_block#rate-limits "Direct link to Rate Limits")
-----------------------------------------------------------------------------------------------
...
Support[​](/naas-api/ethereum/Methods/trace_block#support "Direct link to Support")
-----------------------------------------------------------------------------------

If you encounter any issues or have further questions regarding the trace\_block method, please contact our support team at **[[email protected]](/cdn-cgi/l/email-protection#a4d7d1d4d4cbd6d0e4c7cbcdcac5d4cd8acdcb)**.
...
net\_version](/naas-api/ethereum/Methods/net_version)[Next

trace\_call](/naas-api/ethereum/Methods/trace_call)

* [Overview](/naas-api/ethereum/Methods/trace_block#overview)
* [Request](/naas-api/ethereum/Methods/trace_block#request)
* [Request Parameters](/naas-api/ethereum/Methods/trace_block#request-parameters)
* [Response](/naas-api/ethereum/Methods/trace_block#response)
* [Errors](/naas-api/ethereum/Methods/trace_block#errors)
* [Rate Limits](/naas-api/ethereum/Methods/trace_block#rate-limits)
* [Support](/naas-api/ethereum/Methods/trace_block#support)
