eth\_blockNumber | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_blockNumber)
...
Overview[​](/naas-api/ethereum/Methods/eth_blockNumber#overview "Direct link to Overview")
------------------------------------------------------------------------------------------

The **'eth\_blockNumber'** method returns the current latest block number.

Request[​](/naas-api/ethereum/Methods/eth_blockNumber#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_blockNumber#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
Ethereum](/naas-api/ethereum/)[Next

eth\_call](/naas-api/ethereum/Methods/eth_call)

* [Overview](/naas-api/ethereum/Methods/eth_blockNumber#overview)
* [Request](/naas-api/ethereum/Methods/eth_blockNumber#request)
* [Response](/naas-api/ethereum/Methods/eth_blockNumber#response)
