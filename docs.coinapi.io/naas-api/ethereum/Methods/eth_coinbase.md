eth\_coinbase | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_coinbase)
...
Overview[​](/naas-api/ethereum/Methods/eth_coinbase#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **'eth\_coinbase'** returns the client coinbase address. The coinbase address is the account to pay mining rewards to.
...
eth\_chainID](/naas-api/ethereum/Methods/eth_chainId)[Next

eth\_createAccessList](/naas-api/ethereum/Methods/eth_createAccessList)

* [Overview](/naas-api/ethereum/Methods/eth_coinbase#overview)
