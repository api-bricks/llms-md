eth\_getTransactionByBlockHashAndIndex | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex)
...
Overview[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#overview "Direct link to Overview")
----------------------------------------------------------------------------------------------------------------

The **'eth\_getTransactionByBlockHashAndIndex'** method returns information about a transaction given block hash and transaction index position.

Request[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#request "Direct link to Request")
-------------------------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockHashAndIndex\"}", false);  
...
```
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_getTransactionByBlockHashAndIndex'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockHashAndIndex\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockHashAndIndex\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockHashAndIndex\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#request-parameters "Direct link to Request Parameters")
----------------------------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#response "Direct link to Response")
----------------------------------------------------------------------------------------------------------------
...
eth\_getStorageAt](/naas-api/ethereum/Methods/eth_getStorageAt)[Next

eth\_getTransactionByBlockNumberAndIndex](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex)

* [Overview](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#overview)
* [Request](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex#response)
