eth\_hashrate | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_hashrate)
...
Overview[​](/naas-api/ethereum/Methods/eth_hashrate#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **"eth\_hashrate"** method returns the number of hashes per second that the node is mining with. Only applicable when the node is mining.

Request[​](/naas-api/ethereum/Methods/eth_hashrate#request "Direct link to Request")
------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_hashrate\"}", false);  
...
```
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_hashrate'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_hashrate\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_hashrate\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_hashrate\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_hashrate#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/eth_hashrate#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
eth\_getWork](/naas-api/ethereum/Methods/eth_getWork)[Next

eth\_maxPriorityFeePerGas](/naas-api/ethereum/Methods/eth_maxPriorityFeePerGas)

* [Overview](/naas-api/ethereum/Methods/eth_hashrate#overview)
* [Request](/naas-api/ethereum/Methods/eth_hashrate#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_hashrate#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_hashrate#response)
