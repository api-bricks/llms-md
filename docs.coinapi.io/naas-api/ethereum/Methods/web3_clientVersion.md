web3\_clientVersion | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/web3_clientVersion)
...
Overview[​](/naas-api/ethereum/Methods/web3_clientVersion#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------

The **'web3\_clientVersion'** method returns the current client version.

Request[​](/naas-api/ethereum/Methods/web3_clientVersion#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_clientVersion\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_clientVersion\"}")  
...
request.body = {\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_clientVersion\"}  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"web3_clientVersion\"}");  
...
Response[​](/naas-api/ethereum/Methods/web3_clientVersion#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
txpool\_inspect](/naas-api/ethereum/Methods/txpool_inspect)[Next

web3\_sha3](/naas-api/ethereum/Methods/web3_sha3)

* [Overview](/naas-api/ethereum/Methods/web3_clientVersion#overview)
* [Request](/naas-api/ethereum/Methods/web3_clientVersion#request)
* [Response](/naas-api/ethereum/Methods/web3_clientVersion#response)
