eth\_newBlockFilter | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_newBlockFilter)
...
Overview[​](/naas-api/ethereum/Methods/eth_newBlockFilter#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------

The **'eth\_newBlockFilter'** method creates a filter in the node to notify when a new block arrives. To check if the state has changed, call **'eth\_getFilterChanges'**.
...
Request[​](/naas-api/ethereum/Methods/eth_newBlockFilter#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_newBlockFilter\"}", false);  
...
```
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_newBlockFilter'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_newBlockFilter\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_newBlockFilter\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_newBlockFilter\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_newBlockFilter#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------

* None.

Response[​](/naas-api/ethereum/Methods/eth_newBlockFilter#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
eth\_mining](/naas-api/ethereum/Methods/eth_mining)[Next

eth\_newFilter](/naas-api/ethereum/Methods/eth_newFilter)

* [Overview](/naas-api/ethereum/Methods/eth_newBlockFilter#overview)
* [Request](/naas-api/ethereum/Methods/eth_newBlockFilter#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_newBlockFilter#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_newBlockFilter#response)
