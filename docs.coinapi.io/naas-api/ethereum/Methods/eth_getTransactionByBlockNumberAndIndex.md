eth\_getTransactionByBlockNumberAndIndex | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex)
...
Overview[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#overview "Direct link to Overview")
------------------------------------------------------------------------------------------------------------------
...
Request[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#request "Direct link to Request")
---------------------------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockNumberAndIndex\"}", false);  
...
```
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_getTransactionByBlockNumberAndIndex'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockNumberAndIndex\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockNumberAndIndex\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getTransactionByBlockNumberAndIndex\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#request-parameters "Direct link to Request Parameters")
------------------------------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#response "Direct link to Response")
------------------------------------------------------------------------------------------------------------------
...
eth\_getTransactionByBlockHashAndIndex](/naas-api/ethereum/Methods/eth_getTransactionByBlockHashAndIndex)[Next

eth\_getTransactionByHash](/naas-api/ethereum/Methods/eth_getTransactionByHash)

* [Overview](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#overview)
* [Request](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getTransactionByBlockNumberAndIndex#response)
