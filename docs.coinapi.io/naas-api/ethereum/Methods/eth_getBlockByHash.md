eth\_getBlockByHash | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getBlockByHash)
...
Overview[​](/naas-api/ethereum/Methods/eth_getBlockByHash#overview "Direct link to Overview")
---------------------------------------------------------------------------------------------

The **'eth\_getBlockByHash'** method returns information about a block whose hash is in the request.

Request[​](/naas-api/ethereum/Methods/eth_getBlockByHash#request "Direct link to Request")
------------------------------------------------------------------------------------------
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getBlockByHash#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_getBlockByHash#response "Direct link to Response")
---------------------------------------------------------------------------------------------
...
eth\_createAccessList](/naas-api/ethereum/Methods/eth_getBalance)[Next

eth\_getBlockByNumber](/naas-api/ethereum/Methods/eth_getBlockByNumber)

* [Overview](/naas-api/ethereum/Methods/eth_getBlockByHash#overview)
* [Request](/naas-api/ethereum/Methods/eth_getBlockByHash#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getBlockByHash#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getBlockByHash#response)
