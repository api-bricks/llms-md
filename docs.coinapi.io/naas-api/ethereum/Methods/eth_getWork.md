eth\_getWork | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getWork)
...
Overview[​](/naas-api/ethereum/Methods/eth_getWork#overview "Direct link to Overview")
--------------------------------------------------------------------------------------

The **"eth\_getWork"** method returns the hash of the current block, the seedHash, and the boundary condition to be met ("target")

Request[​](/naas-api/ethereum/Methods/eth_getWork#request "Direct link to Request")
-----------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getWork\"}", false);  
...
```
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_getWork'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getWork\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getWork\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getWork\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getWork#request-parameters "Direct link to Request Parameters")
--------------------------------------------------------------------------------------------------------------------

Response[​](/naas-api/ethereum/Methods/eth_getWork#response "Direct link to Response")
--------------------------------------------------------------------------------------
...
eth\_getUncleCountByBlockNumber](/naas-api/ethereum/Methods/eth_getUncleCountByBlockNumber)[Next

eth\_hashrate](/naas-api/ethereum/Methods/eth_hashrate)

* [Overview](/naas-api/ethereum/Methods/eth_getWork#overview)
* [Request](/naas-api/ethereum/Methods/eth_getWork#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getWork#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getWork#response)
