eth\_getBlockTransactionCountByNumber | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber)
...
Overwiev[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#overwiev "Direct link to Overwiev")
---------------------------------------------------------------------------------------------------------------

The **'eth\_getBlockTransactionCountByNumber'** method returns the number of transactions in the block with the given block number.

Request[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#request "Direct link to Request")
------------------------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByNumber\",\"params\":\"finalized\"}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByNumber\",\"params\":\"finalized\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByNumber\",\"params\":\"finalized\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByNumber\",\"params\":\"finalized\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------------------------------
...
Response[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#response "Direct link to Response")
---------------------------------------------------------------------------------------------------------------
...
eth\_getBlockTransactionCountByHash](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash)[Next

eth\_getCode](/naas-api/ethereum/Methods/eth_getCode)

* [Overwiev](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#overwiev)
* [Request](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber#response)
