eth\_getProof | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getProof)
...
Overview[​](/naas-api/ethereum/Methods/eth_getProof#overview "Direct link to Overview")
---------------------------------------------------------------------------------------

The **"eth\_getProof"** method retrieves the account and storage values of the specified account, including the Merkle-proof.

Request[​](/naas-api/ethereum/Methods/eth_getProof#request "Direct link to Request")
------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getProof\",\"params\":[\"0xe5cB067E90D5Cd1F8052B83562Ae670bA4A211a8\"]}", false);  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getProof\",\"params\":[\"0xe5cB067E90D5Cd1F8052B83562Ae670bA4A211a8\"]}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getProof\",\"params\":[\"0xe5cB067E90D5Cd1F8052B83562Ae670bA4A211a8\"]}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getProof\",\"params\":[\"0xe5cB067E90D5Cd1F8052B83562Ae670bA4A211a8\"]}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getProof#request-parameters "Direct link to Request Parameters")
---------------------------------------------------------------------------------------------------------------------

A filter object containing the following:

* **address:** The address of the account.
* **keys:** Array of storage keys to retrieve the proof for.
* **block:** The block number, or the string "latest", "earliest" or "pending".

Response[​](/naas-api/ethereum/Methods/eth_getProof#response "Direct link to Response")
---------------------------------------------------------------------------------------
...
The method returns the account and storage values of the specified account, including the Merkle-proof.
...
eth\_getLogs](/naas-api/ethereum/Methods/eth_getLogs)[Next

eth\_getStorageAt](/naas-api/ethereum/Methods/eth_getStorageAt)

* [Overview](/naas-api/ethereum/Methods/eth_getProof#overview)
* [Request](/naas-api/ethereum/Methods/eth_getProof#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getProof#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getProof#response)
