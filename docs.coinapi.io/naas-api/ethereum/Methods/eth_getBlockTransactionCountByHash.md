eth\_getBlockTransactionCountByHash | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash)
...
Overview[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------------------------

The **'eth\_getBlockTransactionCountByHash'** method returns the number of transactions in the block with the given block hash.

Request[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#request "Direct link to Request")
----------------------------------------------------------------------------------------------------------
...
request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByHash\"}", false);  
...
const options = {  
  method: 'POST',  
  headers: {accept: 'application/json', 'content-type': 'application/json', '73034021-THIS-IS-SAMPLE-KEY' },  
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_getBlockTransactionCountByHash'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByHash\"}")  
...
request.body = "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByHash\"}"  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_getBlockTransactionCountByHash\"}");  
...
Request Parameters[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#request-parameters "Direct link to Request Parameters")
-------------------------------------------------------------------------------------------------------------------------------------------

* **'block hash'**: **[ Required ]** A string representing the hash (32 bytes) of a block.

Response[​](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#response "Direct link to Response")
-------------------------------------------------------------------------------------------------------------
...
eth\_getBlockReceipts](/naas-api/ethereum/Methods/eth_getBlockReceipts)[Next

eth\_getBlockTransactionCountByNumber](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByNumber)

* [Overview](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#overview)
* [Request](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#request)
* [Request Parameters](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#request-parameters)
* [Response](/naas-api/ethereum/Methods/eth_getBlockTransactionCountByHash#response)
