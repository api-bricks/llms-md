eth\_unsubscribe | CoinAPI.io Documentation
...
[Products](/naas-api/ethereum/Methods/eth_unsubscribe)
...
Overview[​](/naas-api/ethereum/Methods/eth_unsubscribe#overview "Direct link to Overview")
------------------------------------------------------------------------------------------

The **'eth\_unsubscribe'** will cancel the subscription by calling this method with the subscription ID. It returns a boolean indicating that the subscription was canceled successfully.

Request[​](/naas-api/ethereum/Methods/eth_unsubscribe#request "Direct link to Request")
---------------------------------------------------------------------------------------
...
using RestSharp; {  
      ...
      request.AddJsonBody("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_unsubscribe\"}", false);  
...
const options = {  
  ...
  body: JSON.stringify({id: 1, jsonrpc: '2.0', method: 'eth_unsubscribe'})  
};  
...
func main() {  
	...
	payload := strings.NewReader("{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_unsubscribe\"}")  
...
request.body = {\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_unsubscribe\"}  
...
RequestBody body = RequestBody.create(mediaType, "{\"id\":1,\"jsonrpc\":\"2.0\",\"method\":\"eth_unsubscribe\"}");  
...
Response[​](/naas-api/ethereum/Methods/eth_unsubscribe#response "Direct link to Response")
------------------------------------------------------------------------------------------
...
eth\_uninstallFilter](/naas-api/ethereum/Methods/eth_uninstallFilter)[Next

getBeaconBlocksAttestations](/naas-api/ethereum/Methods/getBeaconBlocksAttestations)

* [Overview](/naas-api/ethereum/Methods/eth_unsubscribe#overview)
* [Request](/naas-api/ethereum/Methods/eth_unsubscribe#request)
* [Response](/naas-api/ethereum/Methods/eth_unsubscribe#response)
