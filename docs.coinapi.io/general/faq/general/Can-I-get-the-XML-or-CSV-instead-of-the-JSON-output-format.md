Can I get the XML or CSV instead of the JSON output format? | CoinAPI.io Documentation
...
[Products](/general/faq/general/Can-I-get-the-XML-or-CSV-instead-of-the-JSON-output-format)
...
Yes. Check the documentation for the `output_format` API parameter at <https://docs.coinapi.io/market-data/rest-api#output-data-format>
...
Can I get exchange wallet deposit and withdrawal status?](/general/faq/general/Can-I-get-exchange-wallet-deposit-and-withdrawal-status)[Next
