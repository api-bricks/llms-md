CoinAPI.io - Market data API tutorials test 
...
[See documentation](https://www.coinapi.io/products/market-data-api)

Get the latest BTC/USD exchange rate.

Real-Time Trades (WebSocket) – streaming feed for trading bots & dashboards

Historical OHLCV Data (REST) – perfect for backtesting & analytics
