...
* [**Data Type Filtering**](https://docs.coinapi.io/market-data/rest-api/trades#historical-data-get)
  + The API provides the flexibility to filter by different types of market data. Whether you’re interested in trades, quotes, order books, or [OHLCV](https://www.coinapi.io/blog/understanding-ohlcv-in-market-data-analysis) (Open, High, Low, Close, Volume) data, you can tailor your request to match your needs.
