CoinAPI.io Glossary - Post-Only Order
...
* [How It Works](#link-8fc0be85191e)
* [Practical Applications](#link-d11188a8cb1f)
* [Benefits](#link-c8b505b4acde)
* [Things to Remember](#link-df6ca0755f33)
...
A post-only order adds [liquidity](Liquidity) to the [order book](https://www.coinapi.io/learn/glossary/order-book) instead of taking liquidity. Your order stays as a limit order on the order book. It will not be matched and filled immediately. If conditions for immediate execution are met, like crossing the spread, the system cancels the order. This prevents it from executing as a [market taker](https://www.independentreserve.com/support/glossary). As a result, you benefit from lower maker fees instead of higher taker fees.
