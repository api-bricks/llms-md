CoinAPI.io Glossary - API Rate Limit
...
* [API Rate Limit - Definition](#link-1ec6da9130db)
* [Things to Remember](#link-0f83ca288dc8)

API Rate Limit - Definition
---------------------------

**API Rate Limit** refers to the maximum number of requests that a client can make to an [**Application Programming Interface (API)**](https://www.coinapi.io/learn/glossary/api) within a specified time frame. This mechanism is essential for maintaining the stability, performance, and security of APIs by preventing excessive usage that could lead to service degradation or downtime.
...
One of the most common methods of API rate limiting is **[throttling](https://www.coinapi.io/learn/glossary/api-throttling).** It temporarily restricts the rate of incoming requests by either slowing down responses or blocking them entirely once the limit is reached. Throttling can be applied at different levels, such as API-wide, per user, or application.
