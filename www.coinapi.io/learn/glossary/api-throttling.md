CoinAPI.io Glossary - API Throttling
...
* [What is API Throttling?](#link-4a2c4db035b4)
* [How API Throttling Works](#link-d8d7688d9b98)
* [Benefits of API Throttling](#link-99d16214630c)
* [Things to Remember](#link-445b90cd5a0f)

What is API Throttling?
-----------------------

**API throttling** limits the number of [API](https://www.coinapi.io/learn/glossary/api) requests a user can make within a specified time frame. This mechanism acts as a gatekeeper between users or other applications and the underlying software services. It ensures resources are fairly distributed and prevents any single entity from overwhelming the system.
