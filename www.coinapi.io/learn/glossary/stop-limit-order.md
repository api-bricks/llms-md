CoinAPI.io Glossary - Stop Limit Order
...
A stop-limit order is a type of trade order that combines the features of a stop order and a limit order. It is used to buy or sell a security once its price reaches a specified stop price, but only if the price can be executed within a specified limit price.

Table of Contents

* [What is the Stop Limit Order?](#link-3a90285f5fe5)
* [How it Works](#link-bfe948b10575)
* [Stop Limit Order vs. Stop-Loss Order](#link-51be95ab57bb)
* [Examples of Stop Limit Orders](#link-d4053ec4ab4a)
* [Things to Remember](#link-976441bab730)
...
* **Stop-Loss Order:** Converts to a market order once the stop price is reached, ensuring execution but not the price.
* **Stop Limit Order:** Converts to a limit order at the stop price, providing price control without guaranteed execution.
...
* **Combined Features:** Stop limit orders merge the functionalities of stop orders and limit orders, providing precise control over trade executions.
* **Two Price Points:** Setting both a stop price and a limit price is essential for defining execution conditions.
* **Risk and Reward Balance:** While offering enhanced price control, stop-limit orders carry execution risks, especially in volatile markets where prices can gap.
* **Strategic Use:** These orders are effective for managing risk, protecting profits, and automating trading strategies but require a solid understanding of market dynamics to use effectively.
